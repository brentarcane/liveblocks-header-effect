...
const navigationMenuTriggerStyle = cva(
  ...
  "group inline-flex items-center justify-center rounded-md px-4 py-2 text-sm font-medium leading-6 text-foreground group-hover:text-transparent data-[state=open]:!text-foreground transition-colors duration-150"
);
